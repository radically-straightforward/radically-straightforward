...
> **Advanced**
>
> You may note that the selectors generated by `@radically-straightforward/build` repeat 6 times, for example, `[css~="dlkabzruwmljye"][css~="dlkabzruwmljye"][css~="dlkabzruwmljye"][css~="dlkabzruwmljye"][css~="dlkabzruwmljye"][css~="dlkabzruwmljye"]`.
>
> This exists so that the specificity of inline CSS is greater than the specificity of global CSS, for example:
>
> ```javascript
> css`
>   h1.heading {
...
> ```
>
> In most cases this does what you want and you don’t have to think about it.
